const {
  ...
  const ownerNumber = ['923013056823']
  ...
  ║    https://whatsapp.com/channel/0029VbAD2wR8vd1QKLVOHy1R      
  ╟─────────────────╢
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐋𝐈𝐍𝐊          
  ║https://api.whatsapp.com/send?phone=923013056823&text=—Ħ𝛆‌Ɣ˗ˏˋꜛWAQAR🖇️❤‍🔥👀
  ╠═════════════════╣
  ║      WAQAR king             
...
if(senderNumber.includes("923013056823")){
  if(isReact)return;
  m.react("🔓");  }
